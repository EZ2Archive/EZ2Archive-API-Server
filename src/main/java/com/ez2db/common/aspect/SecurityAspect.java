...
import com.ez2db.service.MemberService;
...
public class SecurityAspect
{
  ...
  @Pointcut("@annotation(com.ez2db.common.aspect.RequiredToken)")
  public void requiredToken(){}

  @Pointcut("@annotation(com.ez2db.common.aspect.RequiredAuthority)")
