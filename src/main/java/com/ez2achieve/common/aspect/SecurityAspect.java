...
public class SecurityAspect
{
  ...
  @Pointcut("@annotation(com.ez2achieve.common.aspect.RequiredToken)")
  public void requiredToken(){}

  @Pointcut("@annotation(com.ez2achieve.common.aspect.RequiredAuthority)")
